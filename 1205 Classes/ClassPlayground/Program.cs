...
namespace ClassPlayground
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Obsah obdelniku s rozmery " + rect1.width + "x" + rect1.height + " je " + rect1.CalculateArea()); ;
            Console.WriteLine("Pomer obdelniku s rozmery " + rect1.width + "x" + rect1.height + " je 1 : " + rect1.CalculateAspectRatio());
                
            int pointX = 5, pointY = 8;
            Console.WriteLine("Obdelnik" + (rect1.ContainsPoint(pointX, pointY, rect1.width, rect1.height) ? " OBSAHUJE " : " NEOBSAHUJE ") + "bod [" + pointX + "," + pointY + "]");
            

            Console.WriteLine("Jello");

            BankAccount account1 = new BankAccount("Jan Novak", "CZK", 100000001);
            BankAccount account2 = new BankAccount("Jana Novakova", "CZK", 100000000);
            account1.balance = account1.Deposit(2000);
            account1.balance = account1.Withdraw(500);
            account2.balance = account2.Deposit(500);
            account1.balance = account1.Transfer(500, 100000001);
